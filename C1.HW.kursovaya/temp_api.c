...
int AddInfo(str_sensor info[])
{
    ...
    AddRecord(info, counter++, 2023, 5, 15, 10, 30, 0, -5);
    AddRecord(info, counter++, 2023, 5, 20, 14, 0, 0, 15);
    AddRecord(info, counter++, 2023, 6, 10, 12, 0, 0, 25);
    AddRecord(info, counter++, 2023, 6, 15, 16, 0, 0, 30);
    return counter;
}
